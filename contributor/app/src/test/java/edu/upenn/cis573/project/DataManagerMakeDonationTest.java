...
public class DataManagerMakeDonationTest {
    ...
    public void testNullContributorId() {
        ...
        assertFalse(dm.makeDonation(null, "123", "10"));
    }

    @Test
    public void testNullFundId() {
        DataManager dm = new DataManager(new WebClient(null, 0));
        assertFalse(dm.makeDonation("123", null, "10"));
    }

    @Test
    public void testNullAmount() {
        DataManager dm = new DataManager(new WebClient(null, 0));
        assertFalse(dm.makeDonation("123", "123", null));
    }
    ...
    public void testUnsuccessfulStatus() {
        ...
        assertFalse(dm.makeDonation("123", "123", "123"));
    }
